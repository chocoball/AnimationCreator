...
void KeyboardTab::setShortcut(int type, QKeySequence ks)
{
    switch (type)
    {
        ...
        case 3:
            ...
            break; // SCALE
        case 4:
            m_pSetting->setShortcutPathSelect(ks);
            break; // PATH
        case 5:
            m_pSetting->setShortcutCopyFrame(ks);
            break; // framedata copy
        case 6:
            m_pSetting->setShortcutPasteFrame(ks);
            break; // framedata paste
        case 7:
            m_pSetting->setShortcutPlayAnime(ks);
            break; // play animation
        case 8:
            m_pSetting->setShortcutStopAnime(ks);
            break; // stop animation
        case 9:
            m_pSetting->setShortcutJumpStartFrame(ks);
            break; // jump start frame
        case 10:
            m_pSetting->setShortcutJumpEndFrame(ks);
            break; // jump end frame
        case 11:
            m_pSetting->setShortcutAddFrameData(ks);
            break; // add framedata
        case 12:
            m_pSetting->setShortcutDelFrameData(ks);
            break; // del framedata
        case 13:
            m_pSetting->setShortcutDelItem(ks);
            break; // del item
        case 14:
            m_pSetting->setShortcutDispItem(ks);
            break; // disp item
        case 15:
            m_pSetting->setShortcutLockItem(ks);
            break; // lock item
        case 16:
            m_pSetting->setShortcutMoveAnimeWindow(ks);
            break; // move animation window
        case 17:
            m_pSetting->setShortcutLockLoupe(ks);
            break; // lock loupe window
        case 18:
            m_pSetting->setShortcutCopyAllFrame(ks);
            break;
        case 19:
            m_pSetting->setShortcutPasteAllFrame(ks);
            break;
        case 20:
            m_pSetting->setShortcutDeleteAllFrame(ks);
            break;
    }
